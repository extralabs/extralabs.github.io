...
$recipient = "form@extralabs.net"; // youremail@domain.com
...
// reside on.
$referers = array ('extralabs.net','www.extralabs.net','extralabs.net','www.extralabs.net');
...
echo "<center><h1><img border='0' src='_borders/logo.gif' width='545' height='108' align='left'> </h1><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p></center><font face='Verdana' size='2'><br><br><br><br>\n";
   ...
   echo "<br><br><br><br>\n";
   echo "<font face='Verdana' size='1'>(c) Copyright ExtraLabs Software 2001-2006. All rights reserved.<br><a href='privacy.htm'>Privacy Policy</a> | <a href='contact.htm'>Contact Us</a> | <a href='extralabs-news.xml'><img border='0' src='rss_button4.gif' width='36' height='14'></a></font><br>\n\n";
   exit;
}
...
// send it off
mail_it(stripslashes($content), ($subject)?stripslashes($subject):"FeedBack", $email, $recipient);
if (file_exists($ar_file)) {
   $fd = fopen($ar_file, "rb");
   $ar_message = fread($fd, filesize($ar_file));
   fclose($fd);
   mail_it($ar_message, ($ar_subject)?stripslashes($ar_subject):"RE: FeedBack", ($ar_from)?$ar_from:$recipient, $email);
}
